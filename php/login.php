...
<li style="float:right"><a class="active" href="" onmousedown = "register()">Register</a></li>
</ul>
...
<p><a  href=""onmousedown = "adlog()" name="adlog"/>FOR ADMIN LOGIN CLICK HERE</p>
</fieldset>
</form>
</div>
</body>
...
//user check
$q = "SELECT pass FROM hosteldb WHERE email='$u'";
...
<script>
function register(){
document.location='./1.php';
}
function adlog(){
document.location='./adlog.php';
}
</script>
