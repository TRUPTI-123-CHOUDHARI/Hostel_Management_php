...
<li><a class="active" href="" onmousedown = "aviewh()">VIEW HOSTELITES</a></li>
...
echo "<center><th>"; echo"UPDATE DATA"; echo "</th></center>";
...
echo 'VACANT ROOM'; echo"</td>";
echo "<td>VACANT ROOM</td>";
echo "<td>VACANT ROOM</td>";
} else {
